...
class JournalEntryUpdate(BaseModel):
    ...
    title: Optional[str] = Field(min_length=1, max_length=500, description="Title of the journal entry")
    notes: Optional[str] = Field(min_length=1, description="Detailed notes/content of the journal entry")
